...
export const sendResolutionProposedToBuyer = async (
  buyer_email: string,
  product_name: string,
            ...
            <tr>
              <td style="background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); padding: 32px 24px; text-align: center;">
                ...
                <p style="margin: 8px 0 0 0; color: #dbeafe; font-size: 14px;">
                  ${
                    proposed_by === "buyer" ? "You proposed" : "Seller proposed"
                  } a solution
                </p>
              </td>
            </tr>
...
export const sendResolutionProposedToSeller = async (
  vendor_email: string,
  product_name: string,
  proposed_by: "buyer" | "seller",
  proposal_number: number,
          ...
          <table role="presentation" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05); overflow: hidden;" cellspacing="0" cellpadding="0" border="0">
            ...
            <tr>
              <td style="background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); padding: 32px 24px; text-align: center;">
                ...
                <p style="margin: 8px 0 0 0; color: #dbeafe; font-size: 14px;">
                  ${
                    proposed_by === "seller" ? "You proposed" : "Buyer proposed"
                  } a solution
                </p>
              </td>
            </tr>
...
export const sendResolutionRejectedToBuyer = async (
  buyer_email: string,
  product_name: string,
...
export const sendResolutionRejectedToSeller = async (
  vendor_email: string,
  product_name: string,
  rejected_by: "buyer" | "seller",
  rejection_count: number,
