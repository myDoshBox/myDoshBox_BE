...
export interface IProductTransaction extends Document {
  ...
  transfer_initiated: boolean; // Flag to track if transfer was initiated
  transfer_initiated_at?: Date; // When transfer was initiated
  ...
  // ✅ MANUAL PAYOUT FIELDS - ADD THESE TOO
  manual_payout_reason?: string; // Reason for manual payout
  manual_payout_requested_at?: Date; // When manual payout was requested
}
