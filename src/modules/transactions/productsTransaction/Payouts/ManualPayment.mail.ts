...
export async function sendBuyerConfirmationEmail(
  ...
  `;
    ...
    console.log("Buyer confirmation email sent - Message ID:", info?.messageId);
  } catch (error) {
...
export async function sendVendorManualPayoutEmail(
  vendor_email: string,
  vendor_name: string,
  transaction_id: string,
  ...
  `;
    ...
    console.log(
      "Vendor manual payout email sent - Message ID:",
      info?.messageId,
    );
  } catch (error) {
...
export async function sendAdminManualPayoutAlert(
  transaction_id: string,
  vendor_name: string,
  payout_amount: number,
  bank_details: any,
  ...
  `;
    ...
    console.log(
      "Admin manual payout alert sent - Message ID:",
      info?.messageId,
    );
  } catch (error) {
