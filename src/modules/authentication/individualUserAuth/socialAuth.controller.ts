...
// ) => {
//   try {
//     // Use the exact redirect URI from your Twitter app settings
...
//     // ✅ Try to get email from Twitter
//     let email: string | undefined;

//     // Method 1: Check if email is in the v2 response
//     if ("email" in userResult.data) {
//       email = (userResult.data as any).email;
//       console.log("✅ Email found in v2 response:", email);
//     }

//     // Method 2: If not found, try v1.1 API
//     if (!email) {
//       try {
//         const verifyResult = await authenticatedClient.v1.verifyCredentials({
//           include_email: true,
//         });
//         email = verifyResult.email;
//         console.log("✅ Email retrieved from v1 API:", email);
//       } catch (emailError) {
//         console.warn(
//           "⚠️ Could not fetch email from Twitter v1 API:",
//           emailError
//         );
//       }
//     }

//     // Fallback to generated email if Twitter doesn't provide one
//     if (!email) {
//       console.warn("⚠️ Twitter did not provide email. Using generated email.");
//       email = `${username}@twitter.generated`;
//     }
...
//     const isNewUser = !user;
//     const hasRealEmail = !email.includes("@twitter.generated");
...
//         email_verified: hasRealEmail, // Only verify if it's a real email
//       });
//       console.log("✅ Created new user via Twitter login:", user.email);
//     } else {
//       // Update existing user with real email if we got one this time
//       if (hasRealEmail && user.email.includes("@twitter.generated")) {
//         console.log("✅ Updating user with real email:", email);
//         user.email = email;
//         user.email_verified = true;
//       }
...
//     // Send welcome email for new users (only if real email)
//     if (isNewUser && hasRealEmail) {
//       await sendWelcomeEmail(user.email).catch((err) => {
//         console.error("Failed to send welcome email:", err);
//       });
//     }
