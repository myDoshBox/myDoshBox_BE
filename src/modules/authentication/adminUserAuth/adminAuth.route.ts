 ...
 */
adminRouter.route("/signup").post(asyncHandler(adminUserRegistration));
 ...
 */
adminRouter.route("/login").post(asyncHandler(adminUserLogin));
...
adminRouter
  ...
  .post(asyncHandler(resendAdminVerificationEmail));
 ...
 *           description: Internal server error
 */
adminRouter.route("/forgot-password").post(asyncHandler(forgotAdminPassword));
