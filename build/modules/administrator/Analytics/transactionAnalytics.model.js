...
const transactionAnalyticsSchema = new mongoose_1.Schema({
...
transactionAnalyticsSchema.pre("save", function (next) {
    ...
    if (doc.payout_status === "transfer_success" ||
 ...
 */
transactionAnalyticsSchema.statics.getFinancialSummary = function (startDate, endDate) {
 ...
 */
transactionAnalyticsSchema.statics.getStatusBreakdown = function (startDate, endDate) {
    return __awaiter(this, void 0, void 0, function* () {
        return this.aggregate([
            {
                $match: {
 ...
 */
transactionAnalyticsSchema.statics.getTopVendors = function () {
    return __awaiter(this, arguments, void 0, function* (limit = 10, startDate, endDate) {
 ...
 */
transactionAnalyticsSchema.statics.getRevenueTrends = function (groupBy, startDate, endDate) {
    return __awaiter(this, void 0, void 0, function* () {
        let groupField;
        if (groupBy === "day") {
...
// ========== CREATE MODEL ==========
const TransactionAnalytics = mongoose_1.default.model("TransactionAnalytics", transactionAnalyticsSchema);
exports.default = TransactionAnalytics;
