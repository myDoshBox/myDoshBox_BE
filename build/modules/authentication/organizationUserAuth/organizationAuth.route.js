...
const organizationAuth_controller_1 = require("./organizationAuth.controller");
...
organizationRouter
    .route("/signup")
    .post((0, asyncHandler_middleware_1.asyncHandler)(organizationAuth_controller_1.organizationUserRegistration));
/**
 * @swagger
 ...
 */
organizationRouter.route("/login").post((0, asyncHandler_middleware_1.asyncHandler)(organizationAuth_controller_1.organizationUserLogin));
/**
 * @swagger
 ...
 */
organizationRouter.get("/verify-email", organizationAuth_controller_1.verifyOrganizationEmail);
/**
 * @swagger
...
organizationRouter
    ...
    .post((0, asyncHandler_middleware_1.asyncHandler)(organizationAuth_controller_1.resendOrganizationVerificationEmail));
/**
 * @swagger
...
organizationRouter
    ...
    .post((0, asyncHandler_middleware_1.asyncHandler)(organizationAuth_controller_1.forgotOrganizationPassword));
/**
 * @swagger
...
organizationRouter
    ...
    .post((0, asyncHandler_middleware_1.asyncHandler)(organizationAuth_controller_1.resetOrganizationPassword));
