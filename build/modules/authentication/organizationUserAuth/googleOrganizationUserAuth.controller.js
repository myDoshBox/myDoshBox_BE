...
const OrganizationUser_model_1 = require("../../users/organizationUsers/OrganizationUser.model");
...
const getGoogleUserDetail = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        console.log("hello");
        const googleUserExist = yield OrganizationUser_model_1.User.findOne({
            sub: userDetails.sub,
        });
        //
        if (!googleUserExist) {
...
const createGoogleUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { name, email, email_verified, picture, sub, contact_email, contact_phone, } = req.body;
        if (!name ||
            !email ||
            !email_verified ||
            !picture ||
        ...
        const emailAlreadyExist = yield OrganizationUser_model_1.User.findOne({
            email,
        });
        ...
        const user = yield OrganizationUser_model_1.User.create({
            name,
            email,
            email_verified,
            picture,
