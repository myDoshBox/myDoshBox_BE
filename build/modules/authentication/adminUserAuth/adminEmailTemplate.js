...
exports.sendAdminPasswordResetSuccessEmail = exports.sendAdminPasswordResetEmail = exports.sendAdminWelcomeEmail = exports.sendAdminVerificationEmail = void 0;
...
const sendAdminVerificationEmail = (email, token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    `;
        ...
        console.log("Admin verification email sent - Message ID:", info === null || info === void 0 ? void 0 : info.messageId);
        return info;
    }
    catch (err) {
...
const sendAdminWelcomeEmail = (email, name) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const transport = yield (0, email_utils_1.generateMailTransporter)();
        const emailMessage = `
    <!DOCTYPE html>
    ...
    `;
        ...
        console.log("Admin welcome email sent - Message ID:", info === null || info === void 0 ? void 0 : info.messageId);
        return info;
    }
    catch (err) {
...
const sendAdminPasswordResetEmail = (email, resetToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    `;
        ...
        console.log("Admin password reset email sent - Message ID:", info === null || info === void 0 ? void 0 : info.messageId);
        return info;
    }
    catch (err) {
...
const sendAdminPasswordResetSuccessEmail = (email) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const transport = yield (0, email_utils_1.generateMailTransporter)();
        const emailMessage = `
    <!DOCTYPE html>
    ...
    `;
        ...
        console.log("Admin password reset success email sent - Message ID:", info === null || info === void 0 ? void 0 : info.messageId);
        return info;
    }
    catch (err) {
...
exports.sendAdminPasswordResetSuccessEmail = sendAdminPasswordResetSuccessEmail;
