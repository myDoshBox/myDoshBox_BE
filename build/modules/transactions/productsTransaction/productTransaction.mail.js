...
exports.sendTransferFailedEmailToVendor = exports.sendTransferSuccessEmailToVendor = exports.sendTransactionEditConfirmationToBuyer = exports.sendTransactionEditNotificationToVendor = exports.sendMediatorInvolvementMailToSeller = exports.sendMediatorInvolvementMailToBuyer = exports.sendTransactionCancellationMailToBuyer = exports.sendSuccessfulEscrowEmailToVendor = exports.sendSuccessfulEscrowEmailToInitiator = exports.sendShippingDetailsEmailToVendor = exports.sendShippingDetailsEmailToInitiator = exports.sendPaymentVerifiedEmailToVendor = exports.sendEscrowInitiationEmailToVendor = exports.sendEscrowInitiationEmailToInitiator = void 0;
...
const sendEscrowInitiationEmailToInitiator = (buyer_email, transaction_id, transaction_total, vendor_name, products, sum_total, status) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const dashboardUrl = "https://mydoshbox.vercel.app/userdashboard/transaction-history/confirm-escrow-product-transaction/transactions-in-progress-history";
...
const sendPaymentVerifiedEmailToVendor = (transaction_id, vendor_name, vendor_email, products, sum_total) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const transport = yield (0, email_utils_1.generateMailTransporter)();
        const supportEmail = "mydoshbox@gmail.com";
        const dashboardUrl = "https://mydoshbox.vercel.app/userdashboard/transaction-history/confirm-escrow-product-transaction/transactions-in-progress-history";
        const productRows = products
            .map((p, index) => `
      <tr style="border-bottom: 1px solid #e5e7eb;">
        <td style="padding: 12px 8px; text-align: center; color: #6b7280; font-size: 13px;">${index + 1}</td>
        <td style="padding: 12px 8px; color: #111827; font-size: 13px; font-weight: 500;">${p.name}</td>
        <td style="padding: 12px 8px; text-align: center; color: #374151; font-size: 13px;">${p.quantity}</td>
        <td style="padding: 12px 8px; text-align: right; color: #111827; font-size: 13px;">₦${Number(p.price).toLocaleString()}</td>
        <td style="padding: 12px 8px; text-align: right; color: #059669; font-size: 13px; font-weight: 600;">₦${(p.price * p.quantity).toLocaleString()}</td>
      </tr>
    `)
            .join("");
        const emailMessage = `
  ...
  `;
        ...
        console.log("Payment verified email sent to vendor - Message ID:", info === null || info === void 0 ? void 0 : info.messageId);
    }
    catch (err) {
        console.error("Error sending payment verified email to vendor:", err);
    }
});
exports.sendPaymentVerifiedEmailToVendor = sendPaymentVerifiedEmailToVendor;
...
const sendSuccessfulEscrowEmailToVendor = (...args_1) => __awaiter(void 0, [...args_1], void 0, function* (transaction_id = "", vendor_name = "", vendor_email = "", product_name = "", vendorPayout = "") {
    try {
        const transport = yield (0, email_utils_1.generateMailTransporter)();
        const supportEmail = "mydoshbox@gmail.com";
        const dashboardUrl = "https://mydoshbox.vercel.app/userdashboard";
...
// Add these email functions to your productTransaction.mail.ts file
/**
 * Send transaction edit notification to vendor
 */
const sendTransactionEditNotificationToVendor = (transaction_id, vendor_name, vendor_email, products, sum_total, transaction_total) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const transport = yield (0, email_utils_1.generateMailTransporter)();
        const supportEmail = "mydoshbox@gmail.com";
        const loginUrl = "https://mydoshbox.vercel.app/login";
          ...
          <table role="presentation" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05); overflow: hidden;" cellspacing="0" cellpadding="0" border="0">
            ...
            <tr>
              <td style="background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); padding: 32px 24px; text-align: center;">
                ...
                <p style="margin: 8px 0 0 0; color: #fef3c7; font-size: 14px;">
                  The buyer has modified the transaction details
                </p>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding: 32px 24px;">
                ...
                <p style="margin: 0 0 24px 0; color: #374151; font-size: 15px; line-height: 1.6;">
                  The buyer has updated transaction <strong>${transaction_id}</strong>. Please review the new details below.
                </p>
                  ...
                  <tr>
                    <td style="padding: 16px;">
                      <p style="margin: 0; color: #92400e; font-size: 13px; font-weight: 700;">
                        ⚠️ Action Required: Please review and confirm the updated transaction
                      </p>
                    </td>
                  </tr>
                </table>
                  ...
                  <tr>
                    <td style="padding: 16px;">
                      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                        ...
                        <tr>
                          <td style="padding: 8px 0 6px 0; color: #6b7280; font-size: 12px;">
                            Product Sum Total
                          </td>
                          <td style="padding: 8px 0 6px 0; color: #059669; font-size: 16px; font-weight: 700; text-align: right;">
                            ₦${Number(sum_total).toLocaleString()}
                          </td>
                        </tr>
                      </table>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-bottom: 20px;">
                  <tr>
                    <td align="center">
                      <a href="${loginUrl}" style="display: inline-block; padding: 12px 28px; background-color: #f59e0b; color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 14px; box-shadow: 0 2px 4px rgba(245, 158, 11, 0.3);">
  ...
  `;
        yield transport.sendMail({
            to: vendor_email,
            from: process.env.VERIFICATION_EMAIL,
            subject: "✏️ Transaction Updated - Review Required",
            html: emailMessage,
        });
    }
    catch (err) {
        console.error("Error sending transaction edit notification to vendor:", err);
    }
});
exports.sendTransactionEditNotificationToVendor = sendTransactionEditNotificationToVendor;
/**
 * Send transaction edit confirmation to buyer
 */
const sendTransactionEditConfirmationToBuyer = (buyer_email, transaction_id, vendor_name, products, sum_total, transaction_total) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const transport = yield (0, email_utils_1.generateMailTransporter)();
        const supportEmail = "mydoshbox@gmail.com";
        const dashboardUrl = "https://mydoshbox.vercel.app/userdashboard";
          ...
          <table role="presentation" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05); overflow: hidden;" cellspacing="0" cellpadding="0" border="0">
            ...
            <tr>
              <td style="padding: 32px 24px;">
                ...
                <p style="margin: 0 0 24px 0; color: #374151; font-size: 15px; line-height: 1.6;">
                  Your transaction with <strong>${vendor_name}</strong> has been successfully updated. The vendor will be notified to review and confirm the changes.
                </p>
                    ...
                    <td style="padding: 16px;">
                      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                        ...
                        <tr>
                          ...
                          <td style="padding: 8px 0 6px 0; color: #111827; font-size: 13px; font-weight: 600; text-align: right;">
                            ${vendor_name}
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td style="padding: 8px 0 0 0; color: #6b7280; font-size: 12px;">
                            Transaction Total
                          </td>
                          <td style="padding: 8px 0 0 0; color: #111827; font-size: 15px; font-weight: 700; text-align: right;">
                            ₦${Number(transaction_total).toLocaleString()}
                          </td>
                        </tr>
                      </table>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background: linear-gradient(135deg, #dbeafe 0%, #bfdbfe 100%); border-radius: 8px; border-left: 4px solid #3b82f6; margin-bottom: 20px;">
                  <tr>
                    <td style="padding: 16px;">
                      <p style="margin: 0 0 8px 0; color: #1e40af; font-size: 13px; font-weight: 700;">
                        ⏳ Next Steps
                      </p>
                      <p style="margin: 0; color: #1e3a8a; font-size: 13px; line-height: 1.6;">
                        We've notified <strong>${vendor_name}</strong> about the changes. Once they confirm, you'll receive an email to proceed with payment.
                      </p>
                    </td>
                  </tr>
                </table>
...
exports.sendTransactionEditConfirmationToBuyer = sendTransactionEditConfirmationToBuyer;
/**
 * Send transfer success email to vendor
 */
const sendTransferSuccessEmailToVendor = (vendorEmail, vendorName, amount, transactionId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const transport = yield (0, email_utils_1.generateMailTransporter)();
        const supportEmail = "mydoshbox@gmail.com";
        const dashboardUrl = "https://mydoshbox.vercel.app/userdashboard";
  ...
  `;
        ...
        console.log("Transfer success email sent - Message ID:", info === null || info === void 0 ? void 0 : info.messageId);
    }
    catch (error) {
        console.error("Error sending transfer success email:", error);
    }
});
exports.sendTransferSuccessEmailToVendor = sendTransferSuccessEmailToVendor;
/**
 * Send transfer failed email to vendor
 */
const sendTransferFailedEmailToVendor = (vendorEmail, vendorName, transactionId, reason) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const transport = yield (0, email_utils_1.generateMailTransporter)();
        const supportEmail = "mydoshbox@gmail.com";
        const dashboardUrl = "https://mydoshbox.vercel.app/userdashboard";
  ...
  `;
        ...
        console.log("Transfer failed email sent to vendor - Message ID:", info === null || info === void 0 ? void 0 : info.messageId);
    }
    catch (error) {
        console.error("Error sending transfer failed email to vendor:", error);
    }
});
exports.sendTransferFailedEmailToVendor = sendTransferFailedEmailToVendor;
