...
const raiseDispute = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    user_email, buyer_email, // prefill this
    ...
    let dispute_raised_by = (_a = req === null || req === void 0 ? void 0 : req.body) === null || _a === void 0 ? void 0 : _a.dispute_raised_by; // allow reassignment
...
const buyerResolveDispute = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield Promise.all([
            (0, productDispute_mail_1.sendBuyerResolutionMailToBuyer)(updateDispute.buyer_email, updateDispute.product_name),
            (0, productDispute_mail_1.sendBuyerResolutionMailToSeller)(updateDispute.vendor_email, updateDispute.product_name),
        ]);
        // if (!updateDispute) {
