...
exports.sendOrganizationPasswordResetSuccessEmail = exports.sendOrganizationPasswordResetEmail = exports.sendOrganizationWelcomeEmail = exports.sendOrganizationVerificationEmail = void 0;
 ...
 */
const sendOrganizationVerificationEmail = (email, token, organizationName) => __awaiter(void 0, void 0, void 0, function* () {
    try {
    ...
    `;
        ...
        console.log("✅ Organization verification email sent - Message ID:", info === null || info === void 0 ? void 0 : info.messageId);
        return info;
    }
    catch (err) {
...
exports.sendOrganizationVerificationEmail = sendOrganizationVerificationEmail;
/**
 ...
 */
const sendOrganizationWelcomeEmail = (email, organizationName) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // ✅ FIXED: Added await here
        const transport = yield (0, email_utils_1.generateMailTransporter)();
        const emailMessage = `
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <div style="text-align: center;">
            <a href="${process.env.DEPLOYED_FRONTEND_BASE_URL}/organization/login" class="button">Login to Organization Dashboard</a>
          </div>
    ...
    `;
        ...
        console.log("✅ Organization welcome email sent - Message ID:", info === null || info === void 0 ? void 0 : info.messageId);
        return info;
    }
    catch (err) {
        const error = err instanceof Error
...
exports.sendOrganizationWelcomeEmail = sendOrganizationWelcomeEmail;
/**
 ...
 * @returns {Promise<SMTPTransport.SentMessageInfo>} Email send result
 */
const sendOrganizationPasswordResetEmail = (email, resetToken, organizationName) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // ✅ FIXED: Added await here
        const transport = yield (0, email_utils_1.generateMailTransporter)();
    ...
    `;
        ...
        console.log("✅ Organization password reset email sent - Message ID:", info === null || info === void 0 ? void 0 : info.messageId);
        return info;
    }
    catch (err) {
        const error = err instanceof Error
...
exports.sendOrganizationPasswordResetEmail = sendOrganizationPasswordResetEmail;
/**
 ...
 * @returns {Promise<SMTPTransport.SentMessageInfo>} Email send result
 */
const sendOrganizationPasswordResetSuccessEmail = (email, organizationName) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // ✅ FIXED: Added await here
        const transport = yield (0, email_utils_1.generateMailTransporter)();
        const emailMessage = `
    ...
    `;
        ...
        console.log("✅ Organization password reset success email sent - Message ID:", info === null || info === void 0 ? void 0 : info.messageId);
        return info;
    }
    catch (err) {
        const error = err instanceof Error
            ? err
            : new Error("Unknown error sending organization password reset success email");
        console.error("❌ Error sending organization password reset success email:", error);
        throw error;
    }
});
exports.sendOrganizationPasswordResetSuccessEmail = sendOrganizationPasswordResetSuccessEmail;
